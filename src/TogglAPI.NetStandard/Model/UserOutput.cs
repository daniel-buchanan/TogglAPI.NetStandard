...
namespace TogglAPI.NetStandard.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserOutput :  IEquatable<UserOutput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserOutput" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>List of found errors</value>
        [DataMember(Name="failure", EmitDefaultValue=false)]
        public List<UserFailure> Failure { get; set; }
        ...
        {
            return this.Equals(input as UserOutput);
        }

        /// <summary>
        /// Returns true if UserOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of UserOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserOutput input)
        {
            if (input == null)
                return false;
