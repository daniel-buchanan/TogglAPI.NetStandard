...
{
    /// <summary>
    /// UsersProjectUsersPost
    /// </summary>
    [DataContract]
    public partial class UsersProjectUsersPost :  IEquatable<UsersProjectUsersPost>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsersProjectUsersPost" /> class.
        /// </summary>
        ...
        public UsersProjectUsersPost(List<long?> clientIds = default(List<long?>), List<long?> projectIds = default(List<long?>), long? startId = default(long?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UsersProjectUsersPost {\n");
        ...
        {
            return this.Equals(input as UsersProjectUsersPost);
        }

        /// <summary>
        /// Returns true if UsersProjectUsersPost instances are equal
        /// </summary>
        /// <param name="input">Instance of UsersProjectUsersPost to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsersProjectUsersPost input)
        {
            if (input == null)
                return false;
