...
namespace TogglAPI.NetStandard.Model
{
    ...
    public partial class SubscriptionCalculatedData :  IEquatable<SubscriptionCalculatedData>, IValidatableObject
    {
        ...
        public SubscriptionCalculatedData(string calculation = default(string), string currency = default(string), long? period = default(long?), long? taxPercentage = default(long?), long? totalAmount = default(long?))
        {
