...
namespace TogglAPI.NetStandard.Model
{
    ...
    public partial class SummaryExportPDFPost :  IEquatable<SummaryExportPDFPost>, IValidatableObject
    {
        ...
        public SummaryExportPDFPost(SummaryAudit audit = default(SummaryAudit), bool? billable = default(bool?), string centsSeparator = default(string), List<int?> clientIds = default(List<int?>), bool? collapse = default(bool?), string dateFormat = default(string), string description = default(string), bool? distinguishRates = default(bool?), DurationFormatEnum? durationFormat = default(DurationFormatEnum?), string endDate = default(string), List<int?> groupIds = default(List<int?>), string grouping = default(string), bool? hideAmounts = default(bool?), bool? hideRates = default(bool?), bool? includeTimeEntryIds = default(bool?), int? maxDurationSeconds = default(int?), int? minDurationSeconds = default(int?), string orderBy = default(string), string orderDir = default(string), List<string> postedFields = default(List<string>), List<int?> projectIds = default(List<int?>), string resolution = default(string), int? rounding = default(int?), int? roundingMinutes = default(int?), string startTime = default(string), string startDate = default(string), string subGrouping = default(string), List<int?> tagIds = default(List<int?>), List<int?> taskIds = default(List<int?>), List<int?> timeEntryIds = default(List<int?>), List<int?> userIds = default(List<int?>))
        {
            this.Audit = audit;
