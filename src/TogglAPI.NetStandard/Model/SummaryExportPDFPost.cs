...
namespace TogglAPI.NetStandard.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SummaryExportPDFPost :  IEquatable<SummaryExportPDFPost>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SummaryExportPDFPost" /> class.
        /// </summary>
        ...
        public SummaryExportPDFPost(SummaryAudit audit = default(SummaryAudit), bool? billable = default(bool?), string centsSeparator = default(string), List<long?> clientIds = default(List<long?>), bool? collapse = default(bool?), string dateFormat = default(string), string description = default(string), bool? distinguishRates = default(bool?), DurationFormatEnum? durationFormat = default(DurationFormatEnum?), string endDate = default(string), List<long?> groupIds = default(List<long?>), string grouping = default(string), bool? hideAmounts = default(bool?), bool? hideRates = default(bool?), bool? includeTimeEntryIds = default(bool?), long? maxDurationSeconds = default(long?), long? minDurationSeconds = default(long?), string orderBy = default(string), string orderDir = default(string), List<string> postedFields = default(List<string>), List<long?> projectIds = default(List<long?>), string resolution = default(string), long? rounding = default(long?), long? roundingMinutes = default(long?), string startTime = default(string), string startDate = default(string), string subGrouping = default(string), List<long?> tagIds = default(List<long?>), List<long?> taskIds = default(List<long?>), List<long?> timeEntryIds = default(List<long?>), List<long?> userIds = default(List<long?>))
        {
            this.Audit = audit;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SummaryExportPDFPost {\n");
        ...
        {
            return this.Equals(input as SummaryExportPDFPost);
        }

        /// <summary>
        /// Returns true if SummaryExportPDFPost instances are equal
        /// </summary>
        /// <param name="input">Instance of SummaryExportPDFPost to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SummaryExportPDFPost input)
        {
            if (input == null)
                return false;
