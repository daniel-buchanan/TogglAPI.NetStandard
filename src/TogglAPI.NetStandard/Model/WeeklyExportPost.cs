...
namespace TogglAPI.NetStandard.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WeeklyExportPost :  IEquatable<WeeklyExportPost>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WeeklyExportPost" /> class.
        /// </summary>
        ...
        public WeeklyExportPost(bool? billable = default(bool?), string calculate = default(string), List<long?> clientIds = default(List<long?>), string description = default(string), string endDate = default(string), bool? groupByTask = default(bool?), List<long?> groupIds = default(List<long?>), string grouping = default(string), long? maxDurationSeconds = default(long?), long? minDurationSeconds = default(long?), List<string> postedFields = default(List<string>), List<long?> projectIds = default(List<long?>), long? rounding = default(long?), long? roundingMinutes = default(long?), string startTime = default(string), string startDate = default(string), List<long?> tagIds = default(List<long?>), List<long?> taskIds = default(List<long?>), List<long?> timeEntryIds = default(List<long?>), List<long?> userIds = default(List<long?>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WeeklyExportPost {\n");
        ...
        {
            return this.Equals(input as WeeklyExportPost);
        }

        /// <summary>
        /// Returns true if WeeklyExportPost instances are equal
        /// </summary>
        /// <param name="input">Instance of WeeklyExportPost to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WeeklyExportPost input)
        {
            if (input == null)
                return false;
