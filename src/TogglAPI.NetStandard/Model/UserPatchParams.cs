...
namespace TogglAPI.NetStandard.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserPatchParams :  IEquatable<UserPatchParams>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserPatchParams {\n");
        ...
        {
            return this.Equals(input as UserPatchParams);
        }

        /// <summary>
        /// Returns true if UserPatchParams instances are equal
        /// </summary>
        /// <param name="input">Instance of UserPatchParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserPatchParams input)
        {
            if (input == null)
                return false;
