...
namespace TogglAPI.NetStandard.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StatusProjectStatus :  IEquatable<StatusProjectStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StatusProjectStatus" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StatusProjectStatus {\n");
        ...
        {
            return this.Equals(input as StatusProjectStatus);
        }

        /// <summary>
        /// Returns true if StatusProjectStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of StatusProjectStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StatusProjectStatus input)
        {
            if (input == null)
                return false;
