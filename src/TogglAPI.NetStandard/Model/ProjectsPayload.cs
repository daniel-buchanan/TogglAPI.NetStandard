...
namespace TogglAPI.NetStandard.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProjectsPayload :  IEquatable<ProjectsPayload>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectsPayload {\n");
        ...
        {
            return this.Equals(input as ProjectsPayload);
        }

        /// <summary>
        /// Returns true if ProjectsPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectsPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectsPayload input)
        {
            if (input == null)
                return false;
