...
namespace TogglAPI.NetStandard.Model
{
    ...
    public partial class TasksTaskStatus :  IEquatable<TasksTaskStatus>, IValidatableObject
    {
        ...
        public TasksTaskStatus(int? billableAmount = default(int?), int? billableSeconds = default(int?), string currency = default(string), int? estimatedSeconds = default(int?), int? id = default(int?), int? trackedSeconds = default(int?))
        {
