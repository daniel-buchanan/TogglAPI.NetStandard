...
namespace TogglAPI.NetStandard.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DetailedPost :  IEquatable<DetailedPost>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DetailedPost" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as DetailedPost);
        }

        /// <summary>
        /// Returns true if DetailedPost instances are equal
        /// </summary>
        /// <param name="input">Instance of DetailedPost to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DetailedPost input)
        {
            if (input == null)
                return false;
