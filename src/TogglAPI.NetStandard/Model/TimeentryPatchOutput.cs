...
namespace TogglAPI.NetStandard.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TimeentryPatchOutput :  IEquatable<TimeentryPatchOutput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeentryPatchOutput" /> class.
        /// </summary>
        ...
        public List<TimeentryPatchFailure> Failure { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TimeentryPatchOutput {\n");
        ...
        {
            return this.Equals(input as TimeentryPatchOutput);
        }

        /// <summary>
        /// Returns true if TimeentryPatchOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of TimeentryPatchOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimeentryPatchOutput input)
        {
            if (input == null)
                return false;
