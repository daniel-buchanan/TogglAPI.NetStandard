...
namespace TogglAPI.NetStandard.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GroupPayload :  IEquatable<GroupPayload>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GroupPayload);
        }

        /// <summary>
        /// Returns true if GroupPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupPayload input)
        {
            if (input == null)
                return false;
