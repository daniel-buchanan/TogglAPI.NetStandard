...
namespace TogglAPI.NetStandard.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DtoProjectFilterParamRequest :  IEquatable<DtoProjectFilterParamRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DtoProjectFilterParamRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DtoProjectFilterParamRequest {\n");
        ...
        {
            return this.Equals(input as DtoProjectFilterParamRequest);
        }

        /// <summary>
        /// Returns true if DtoProjectFilterParamRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DtoProjectFilterParamRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DtoProjectFilterParamRequest input)
        {
            if (input == null)
                return false;
