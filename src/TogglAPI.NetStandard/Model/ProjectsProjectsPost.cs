...
namespace TogglAPI.NetStandard.Model
{
    ...
    public partial class ProjectsProjectsPost :  IEquatable<ProjectsProjectsPost>, IValidatableObject
    {
        ...
        public ProjectsProjectsPost(List<int?> clientIds = default(List<int?>), string currency = default(string), List<int?> ids = default(List<int?>), bool? isActive = default(bool?), bool? isBillable = default(bool?), bool? isPrivate = default(bool?), string name = default(string), int? pageSize = default(int?), int? start = default(int?))
        {
