...
{
    /// <summary>
    /// CalculateCalculateRequest
    /// </summary>
    [DataContract]
    public partial class CalculateCalculateRequest :  IEquatable<CalculateCalculateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CalculateCalculateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CalculateCalculateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CalculateCalculateRequest" /> class.
        /// </summary>
        ...
        public CalculateCalculateRequest(int? period = default(int?), int? pricingPlanId = default(int?), int? userCount = default(int?))
        {
            ...
            if (period == null)
            {
                throw new InvalidDataException("period is a required property for CalculateCalculateRequest and cannot be null");
            }
            else
            {
                this.Period = period;
            ...
            {
                throw new InvalidDataException("pricingPlanId is a required property for CalculateCalculateRequest and cannot be null");
            }
            else
            {
            ...
            if (userCount == null)
            {
                throw new InvalidDataException("userCount is a required property for CalculateCalculateRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CalculateCalculateRequest {\n");
        ...
        {
            return this.Equals(input as CalculateCalculateRequest);
        }

        /// <summary>
        /// Returns true if CalculateCalculateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CalculateCalculateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CalculateCalculateRequest input)
        {
            if (input == null)
                return false;
