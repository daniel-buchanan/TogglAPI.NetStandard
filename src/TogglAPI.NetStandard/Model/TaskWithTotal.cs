...
namespace TogglAPI.NetStandard.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaskWithTotal :  IEquatable<TaskWithTotal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskWithTotal" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TaskWithTotal);
        }

        /// <summary>
        /// Returns true if TaskWithTotal instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskWithTotal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskWithTotal input)
        {
            if (input == null)
                return false;
