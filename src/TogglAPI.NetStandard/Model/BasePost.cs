...
namespace TogglAPI.NetStandard.Model
{
    ...
    public partial class BasePost :  IEquatable<BasePost>, IValidatableObject
    {
        ...
        public BasePost(bool? billable = default(bool?), List<long?> clientIds = default(List<long?>), string description = default(string), string endDate = default(string), List<long?> groupIds = default(List<long?>), long? maxDurationSeconds = default(long?), long? minDurationSeconds = default(long?), List<string> postedFields = default(List<string>), List<long?> projectIds = default(List<long?>), long? rounding = default(long?), long? roundingMinutes = default(long?), string startTime = default(string), string startDate = default(string), List<long?> tagIds = default(List<long?>), List<long?> taskIds = default(List<long?>), List<long?> timeEntryIds = default(List<long?>), List<long?> userIds = default(List<long?>))
        {
