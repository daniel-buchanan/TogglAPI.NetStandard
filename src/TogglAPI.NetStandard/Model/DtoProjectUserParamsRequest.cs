...
namespace TogglAPI.NetStandard.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DtoProjectUserParamsRequest :  IEquatable<DtoProjectUserParamsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DtoProjectUserParamsRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DtoProjectUserParamsRequest {\n");
        ...
        {
            return this.Equals(input as DtoProjectUserParamsRequest);
        }

        /// <summary>
        /// Returns true if DtoProjectUserParamsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DtoProjectUserParamsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DtoProjectUserParamsRequest input)
        {
            if (input == null)
                return false;
