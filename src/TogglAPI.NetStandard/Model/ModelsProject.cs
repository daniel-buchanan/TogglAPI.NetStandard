...
namespace TogglAPI.NetStandard.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ModelsProject :  IEquatable<ModelsProject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelsProject" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ModelsProject);
        }

        /// <summary>
        /// Returns true if ModelsProject instances are equal
        /// </summary>
        /// <param name="input">Instance of ModelsProject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModelsProject input)
        {
            if (input == null)
                return false;
