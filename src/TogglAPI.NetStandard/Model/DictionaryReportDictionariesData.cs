...
namespace TogglAPI.NetStandard.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DictionaryReportDictionariesData :  IEquatable<DictionaryReportDictionariesData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DictionaryReportDictionariesData" /> class.
        /// </summary>
        ...
        public DictionaryReportDictionariesData(DictionaryGeneralDictionary clients = default(DictionaryGeneralDictionary), DictionaryProjectDictionary projects = default(DictionaryProjectDictionary), DictionaryGeneralDictionary tags = default(DictionaryGeneralDictionary), DictionaryTaskDictionary tasks = default(DictionaryTaskDictionary), DictionaryGeneralDictionary userGroups = default(DictionaryGeneralDictionary), DictionaryUserDictionary users = default(DictionaryUserDictionary))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DictionaryReportDictionariesData {\n");
        ...
        {
            return this.Equals(input as DictionaryReportDictionariesData);
        }

        /// <summary>
        /// Returns true if DictionaryReportDictionariesData instances are equal
        /// </summary>
        /// <param name="input">Instance of DictionaryReportDictionariesData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DictionaryReportDictionariesData input)
        {
            if (input == null)
                return false;
