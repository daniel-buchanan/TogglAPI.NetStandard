...
namespace TogglAPI.NetStandard.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://localhost:8080/api/v9";
        ...
        public Configuration(
            ...
            string basePath = "https://localhost:8080/api/v9") : this()
        {
        ...
        {
            String report = "C# SDK (TogglAPI.NetStandard) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 9\n";
