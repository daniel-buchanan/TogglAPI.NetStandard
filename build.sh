...
${nuget_cmd} install src/TogglAPI.NetStandard/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/TogglAPI.NetStandard.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/TogglAPI.NetStandard.dll \
-recurse:'src/TogglAPI.NetStandard/*.cs' \
-doc:bin/TogglAPI.NetStandard.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/TogglAPI.NetStandard.dll was created successfully"
fi
